...
public record struct CustomerId() : IValueObject<CustomerId>
{
    ...
    public static CustomerId Unknown => new() { _id = null };

    public static CustomerId Empty => new() { _id = Guid.Empty };
    ...
    public static bool TryParse([NotNullWhen(true)] string? s, [MaybeNullWhen(false)] out CustomerId result)
